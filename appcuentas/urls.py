...
urlpatterns = patterns('appcuentas.views',
    ...
    url(r'^projects/delete-board/$', 'view_delete_board'),
    url(r'^projects/create-column/$', 'view_create_column'),
    url(r'^projects/delete-column/$', 'view_delete_column'),
    url(r'^projects/create-package/$', 'view_create_paquete'),
    url(r'^projects/delete-package/$', 'view_delete_paquete'),
